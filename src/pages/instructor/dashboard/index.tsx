...
import InstructorDashboarLayout from "@component/layout/InstructorDashboardLayout";
...
const Dashboard = () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Dashboard" iconName="bag_filled"  from="Instructor"/>
{stats && 
<>
...
Dashboard.layout = InstructorDashboarLayout;
