...
const toggleDialog = useCallback(() => {
  ...
  return (
    <div>
      <DashboardPageHeader title="All Courses" iconName="box"from="Instructor"
...
{ coursesData && coursesData.length>0? <>
      {coursesData.slice(from,to).map((item,ind) => (
          ...
          >
            ...
            <Link href={`/instructor/courses/edit/${item._id}`}>
              <Typography
                as="a"
                href={`/instructor/courses/edit/${item._id}`}
                color="inherit"
              >
...
CoursesList.layout = InstructorDashboardLayout;
