...
const TrainingsList = () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Your Trainings" iconName="box"  from="Instructor"
      button={
        <Link href="/instructor/trainings/new">
          <a>
...
<>
      {trainingsData.slice(from,to).map((item,ind) => (
          ...
          key={ind}
            // as="a"
            // href={`/instructor/trainings/${item._id}`}
            my="1rem"
            padding="15px 24px"
          >
            <div>
            ...
            <Link href={`/instructor/trainings/edit/${item._id}`}>
              <Typography
                as="a"
                href={`/instructor/trainings/edit/${item._id}`}
                color="inherit"
              >
...
TrainingsList.layout = InstructorDashboardLayout;
