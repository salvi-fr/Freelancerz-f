...
const PublicationsList = () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Your Publications" iconName="box"  from="Admin"
      button={
...
<>
      {publicationsData.slice(from,to).map((item,ind) => (
          ...
          key={ind}
            // as="a"
            // href={`/admin/publications/${item._id}`}
            my="1rem"
            padding="15px 24px"
          >
            <div>
            ...
            <Link href={`/admin/publications/edit/${item._id}`}>
              <Typography
                as="a"
                href={`/admin/publications/edit/${item._id}`}
                color="inherit"
              >
...
PublicationsList.layout = AdminDashboardLayout;
