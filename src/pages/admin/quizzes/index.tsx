...
const handleDelete = async () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Your Quizzes" iconName="box"  from="Admin"
      button={
      ...
      {quizzesData.slice(from,to).map((item,ind) => (
        ...
        //  key={ind}>
          ...
          >
            ...
            <Link href={`/admin/quizzes/edit/${item._id}`}>
              <Typography
                as="a"
                href={`/admin/quizzes/edit/${item._id}`}
                color="inherit"
              >
...
QuizzesList.layout = AdminDashboardLayout;
