...
import AdminDashboarLayout from "@component/layout/AdminDashboardLayout";
...
const Dashboard = () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Dashboard" iconName="bag_filled"  from="Admin"/>
{stats && 
<>
...
Dashboard.layout = AdminDashboarLayout;
