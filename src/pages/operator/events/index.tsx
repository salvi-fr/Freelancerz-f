...
const EventsList = () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Events" iconName="box"  from="Operator"
      button={
        <Link href="/operator/events/new">
          <a>
...
<>
      {eventsData.slice(from,to).map((item,ind) => (
          ...
          >
            ...
            <Link href={`/operator/events/edit/${item._id}`}>
              <Typography
                as="a"
                href={`/operator/events/edit/${item._id}`}
                color="inherit"
              >
...
EventsList.layout = OperatorDashboardLayout;
