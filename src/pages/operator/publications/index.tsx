...
const PublicationsList = () => {
  ...
  return (
    <div>
      <DashboardPageHeader title="Your Publications" iconName="box"  from="Operator"
      button={
        <Link href="/operator/publications/new">
          <a>
...
<>
      {publicationsData.slice(from,to).map((item,ind) => (
          ...
          key={ind}
            // as="a"
            // href={`/operator/publications/${item._id}`}
            my="1rem"
            padding="15px 24px"
          >
            <div>
            ...
            <Link href={`/operator/publications/edit/${item._id}`}>
              <Typography
                as="a"
                href={`/operator/publications/edit/${item._id}`}
                color="inherit"
              >
...
PublicationsList.layout = OperatorDashboardLayout;
